...
const typeHref: Record<string, string> = {
  ...
  takeaway_order: "/dashboard/kitchen",
  waitlist_order: "/dashboard/tables",
  waitlist_seated: "/dashboard/kitchen",
  reservation_order: "/dashboard/tables",
  reservation_reminder: "/dashboard/tables",
  reservation_clear_table: "/dashboard/tables",
